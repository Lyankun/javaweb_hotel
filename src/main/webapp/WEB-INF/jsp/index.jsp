...
<head>
	...
	<title>海日泰集团酒店管理系统</title>
	<link rel="stylesheet" href="static/lib/layui/css/layui.css">
	<link rel="stylesheet" type="text/css" href="static/css/back/Lyankun-layui.css" />
			...
			<ul class="layui-nav hp-nav-none">
				<li class="layui-nav-item">
					<a href="javascript:;"  class="hp-user-name">
						<img src="http://qgddj7o5v.hn-bkt.clouddn.com/001.jpg" class="layui-circle-img layui-anim-upbit">
						<span class="hp-kd">管理员</span>
					</a>
						...
						<div carousel-item style="height: 750px;">
							<div>
								<div class="layui-bg-green demo-carousel">
									<p style="font-size: 30px;">海日泰集团酒店管理系统</p>

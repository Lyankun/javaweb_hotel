...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "okO4sdxcDrVWBdZnFt2zmnqi-d9FLBYG9YEv6gh9";
    static  String SECRET_KEY = "vSlfR8-E08ungzevU7aXSbq-tZ_E4hDrGoC3JAVN";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）  
    static String bucketname = "hotelk051314";
    //上传到七牛后保存的文件名  
